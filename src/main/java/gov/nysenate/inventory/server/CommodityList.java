  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (httpSession==null) {
                ...
                db = new DbConnect();
                log.info(db.ipAddr + "|" + "****SESSION NOT FOUND CommodityList.processRequest ");                
                try {
                   userFallback  = request.getParameter("userFallback");
                }
                catch (Exception e) {
                    log.info(db.ipAddr + "|" + "****SESSION NOT FOUND CommodityList.processRequest could not process Fallback Username. Generic Username will be used instead.");                
                } 
           ...
           Gson gson = new GsonBuilder()
            ...
            Logger.getLogger(CommodityList.class.getName()).info(db.ipAddr+"|"+"Servlet CommodityList : Start");
            ...
            Logger.getLogger(CommodityList.class.getName()).info(db.ipAddr+"|"+ "db.getCommodityList(+'"+keywords.trim()+"', '"+userFallback+"')");
            ...
            Logger.getLogger(CommodityList.class.getName()).info(db.ipAddr+"|"+ "commodityResults:"+commodityResults);
            ...
            Logger.getLogger(CommodityList.class.getName()).info(db.ipAddr+"|"+ "returning:"+json);
            out.print(json);


            Logger.getLogger(CommodityList.class.getName()).info(db.ipAddr+"|"+"Servlet CommodityList : end");
        } finally {
