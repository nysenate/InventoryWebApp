            ...
            throws ServletException, IOException
    {
        ...
        try {
            ...
            if (httpSession == null) {
                ...
                db = new DbConnect();
                log.info("****IMGUPLOAD SESSION NOT FOUND ImgUpload.processRequest ");
                try {
                    userFallback = request.getParameter("userFallback");
                } catch (Exception e) {
                    log.info("****IMGUPLOAD SESSION NOT FOUND ImgUpload.processRequest could not process Fallback Username. Generic Username will be used instead.");
                }
